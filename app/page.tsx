          ...
          <div className="container-custom">
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-start">
              ...
              <div className="bg-gray-50 rounded-2xl p-6 md:p-8">
                <h3 className="text-xl font-bold text-gray-900 mb-6">Informazioni</h3>
                ...
                <div className="flex items-start space-x-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Via Lodovico Ariosto, 19</p>
                    <p className="text-gray-600">20145 Milano MI</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3 mb-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+393791721331" className="text-blue-600 hover:text-blue-700 font-medium">379 172 1331</a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-green-600 font-medium">Aperto 24 ore su 24</p>
                    <p className="text-gray-600 text-sm">7 giorni su 7, festivi inclusi</p>
                  </div>
                </div>
                ...
                <div className="border-t border-gray-200 pt-6">
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900">Vedi le recensioni su Google</p>
                        <p className="text-sm text-gray-500">Leggi cosa dicono i nostri clienti</p>
                      </div>
                    </div>
