        ...
        <article className="container-custom max-w-4xl">
          ...
          <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-8 md:p-12 text-white mb-12">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                ...
                onClick={() => trackConversion('whatsapp_click', 'article_hero')}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center space-x-2 bg-green-500 text-white font-bold py-3 px-6 rounded-lg hover:bg-green-600 transition-colors"
              >
          ...
          <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-8 md:p-12 text-white text-center mt-12">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href={`https://wa.me/${businessData.phoneFormatted.replace(/\+/g, '')}?text=Ciao, vorrei un preventivo per un trasloco a Milano`}
                onClick={() => trackConversion('whatsapp_click', 'article_bottom_cta')}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center space-x-2 bg-green-500 text-white font-bold py-4 px-8 rounded-lg hover:bg-green-600 transition-colors text-lg"
              >
